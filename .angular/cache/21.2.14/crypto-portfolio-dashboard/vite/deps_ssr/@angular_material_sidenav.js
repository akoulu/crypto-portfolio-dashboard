...
var MatDrawer = class _MatDrawer {
  ...
  _openedVia = null;
  _animationStarted = new import_rxjs2.Subject();
  _animationEnd = new import_rxjs2.Subject();
  ...
  openedStart = this._animationStarted.pipe((0, import_operators2.filter)(() => this.opened), (0, import_operators2.mapTo)(void 0));
  _closedStream = this.openedChange.pipe((0, import_operators2.filter)((o) => !o), (0, import_operators2.map)(() => {
  }));
  closedStart = this._animationStarted.pipe((0, import_operators2.filter)(() => !this.opened), (0, import_operators2.mapTo)(void 0));
  _destroyed = new import_rxjs2.Subject();
  onPositionChanged = new EventEmitter();
  _content;
  _modeChanged = new import_rxjs2.Subject();
  _injector = inject(Injector);
  _changeDetectorRef = inject(ChangeDetectorRef);
  constructor() {
...
var MatDrawerContainer = class _MatDrawerContainer {
  ...
  _right = null;
  _destroyed = new import_rxjs2.Subject();
  _doCheckSubject = new import_rxjs2.Subject();
  _contentMargins = {
    left: null,
    right: null
  };
  _contentMarginChanges = new import_rxjs2.Subject();
  get scrollable() {
  ...
  ngAfterContentInit() {
    ...
    this._ngZone.runOutsideAngular(() => {
      this._doCheckSubject.pipe((0, import_operators2.debounceTime)(10), (0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => this.updateContentMargins());
    });
  }
  ngOnDestroy() {
  ...
  _watchDrawerToggle(drawer) {
    drawer._animationStarted.pipe((0, import_operators2.takeUntil)(this._drawers.changes)).subscribe(() => {
      this.updateContentMargins();
      this._changeDetectorRef.markForCheck();
    });
    if (drawer.mode !== "side") {
