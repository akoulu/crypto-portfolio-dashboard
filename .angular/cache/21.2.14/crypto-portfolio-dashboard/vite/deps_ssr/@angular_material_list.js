...
import {
  NG_VALUE_ACCESSOR
} from "./chunk-YLQBIG4G.js";
import {
  MAT_RIPPLE_GLOBAL_OPTIONS,
  MatRippleModule,
  RippleRenderer,
  _StructuralStylesLoader
} from "./chunk-5ZDZ54H5.js";
import {
  A,
  CdkObserveContent,
  ENTER,
...
var MatListItemBase = class _MatListItemBase {
  ...
  _subscriptions = new import_rxjs3.Subscription();
  ...
  _monitorProjectedLinesAndTitle() {
    this._ngZone.runOutsideAngular(() => {
      this._subscriptions.add((0, import_rxjs3.merge)(this._lines.changes, this._titles.changes).subscribe(() => this._updateItemLines(false)));
    });
  }
